...
**[Math-Magician]**
Bookstore is a website built with react
...
```sh
  cd my-folder,
  git clone https://github.com/chiedozie013/bookstore,
  npm install
  npm run start
```
...
Feel free to check the [issues page](https://github.com/chiedozie013/bookstore/issues).
...
This project is [MIT](https://github.com/chiedozie013/bookstore/blob/main/LICENSE) licensed.
